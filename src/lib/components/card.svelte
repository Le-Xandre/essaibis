<script>
  ...
  export let back_img =
    "https://tcg.Cyberpunk.com/assets/img/global/tcg-card-back-2x.jpg";
  export let img = "";

  export let name = "";
  export let number = "0";
  export let subtypes = "basic";
  export let supertype = " cyberpunk";
  ...
  let img_base = img.startsWith("http") ? "" : "https://images.Cyberpunktcg.io/";
  let front_img = "";
...
>
  <div class="card__translater">
    <button
      ...
      on:blur={deactivate}
      aria-label="Expand the Cyberpunk Card; {name}."
      tabindex="0"
    >
      <img
        class="card__back"
        src={back_img}
        alt="The back of a Cyberpunk Card, a Pokeball in the center with Cyberpunk logo above and below"
        loading="lazy"
        width="660"
        height="921"
      />
      <div class="card__front">
        <img
          src={front_img}
          alt="Front design of the {name} Cyberpunk Card, with the stats and info around the edge"
          on:load={imageLoader}
          loading="lazy"
          width="660"
          height="921"
